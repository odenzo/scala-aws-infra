...
lazy val compileSettings =
  Seq(
    scalacOptions ++= optsV2_13_5 ++ warningsV2_13_5 ++ lintersV2_13_5 //  ++ Seq("-release", "11")
...
val libs = {
  Seq("com.lihaoyi" %% "pprint" % pprintV, "com.lihaoyi" %% "os-lib" % oslibV)
}

val libs_test = Seq("org.scalameta" %% "munit" % munitV % Test)
